    ...
    return (
        <div>
            ...
            <div className=" grid md:grid-cols-2">
                <div >
                    <img className="  h-[250px] md:h-[750px] lg:h-[680px] w-
                1/2 " src={background} alt="" />

                </div>
                <div>
                    <img className="w-full blur-[5px] opacity-90 h-[540px] md:h-[680px] relative" src={signuppic} alt="" />
                    {/*  */}
                    <div className="absolute ml-4 md:ml-[230px] -mt-[246px] md:-mt-[700px] lg:-mt-[500px] text-white">
            ...
            {/* 2nd part */}
            <div id="shadow-maker" className="rounded-xl md:rounded-md shrink-0 mx-4 max-w-[290px] md:max-w-[470px] absolute -mt-[650px] md:-mt-[550px] lg:-mt-[620px] md:mx-[130px] lg:mx-[350px] bg-[#062244]">
                <form onSubmit={signup} className="card-body">
                    ...
                    <div className="form-control mt-4 ml-1 " >
                        ...
                        <div className="flex items-center gap-2 md:gap-6 mt-6">
                            <div className="text-sky-300 w-[45px] md:w-[110px]">
                                <hr />
                                <hr />
                                <hr />

                            </div>
                            <p className="text-base md:text-[20px] text-gray-300 font-semibold mx-auto">Continue with</p>
